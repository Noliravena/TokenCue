...
/// Replay adapter for the same canonical policy core used by the TokenCue app.
...
/// compare the adaptive policy against the flat refresh frequencies TokenCue also offers
