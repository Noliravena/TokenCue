...
The replay targets do not import the application or provider-engine targets; they share only the
package-internal, Foundation-only `AdaptiveRefreshCore` target with the app. They do not record app behavior, scan
