...
enum CLIServeStartupError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case let .missingDashboardToken(host):
            "--dashboard-token (or TOKENCUE_DASHBOARD_TOKEN) is required for non-loopback --host '\(host)'."
...
extension TokenCueCLI {
    /// Startup validation for `tokencue serve` binding and dashboard-token flags.
