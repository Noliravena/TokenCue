...
extension TokenCueCLI {
    ...
    static func configSettingAPIKey(
        ...
        apiKey: String,
        enableProvider: Bool,
        accountOptions: ConfigAPIKeyAccountOptions? = nil) -> TokenCueConfig
    {
    ...
    static func configProviderStatuses(_ config: TokenCueConfig) -> [ConfigProviderStatusResult] {
