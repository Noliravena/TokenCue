...
extension CLIServeWebUI {
    ...
    <head>
      ...
      <title>TokenCue Dashboard</title>
      <style>
        :root {
    ...
    <body>
      <main class="shell">
        ...
        <section id="auth" class="notice" aria-labelledby="auth-title">
          ...
          <p>Enter the bearer token configured for this TokenCue server.</p>
      ...
      <script>
        ...
        const tokenKey = "tokencue.dashboardToken";
        ...
        function renderSnapshot(snapshot) {
          ...
          elements.version.textContent = host.tokenCueVersion ? `v${host.tokenCueVersion}` : "";
