    ...
    static func live() -> Self {
        Self(
            notification: {
                ...
                NotificationCenter.default.post(name: .tokencueOpenSettings, object: request)
...
struct HiddenWindowView: View {
    ...
    var body: some View {
        Color.clear
            ...
            .onReceive(NotificationCenter.default.publisher(for: .tokencueOpenSettings)) { notification in
...
final class KeepaliveWindowConfiguratorView: NSView {
    ...
    override func viewDidMoveToWindow() {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("TokenCueLifecycleKeepalive")
