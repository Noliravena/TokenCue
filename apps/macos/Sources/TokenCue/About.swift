...
func showAbout() {
    ...
    // Product identity is TokenCue; third-party MIT notices live in THIRD_PARTY_NOTICES.
    let credits = NSMutableAttributedString(string: "TokenCue — MIT License\n")
    credits.append(makeLink("GitHub", urlString: "https://github.com/Noliravena/TokenCue"))
    credits.append(separator)
    credits.append(makeLink("Notices", urlString: "https://github.com/Noliravena/TokenCue/blob/main/THIRD_PARTY_NOTICES.md"))
