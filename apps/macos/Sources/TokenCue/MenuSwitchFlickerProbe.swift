...
/// unless `TOKENCUE_FLICKER_PROBE_DIR` is set at launch. When armed it opens the
...
enum MenuSwitchFlickerProbe {
    ...
    nonisolated static func debugLog(_ line: @autoclosure () -> String) {
        guard let dir = ProcessInfo.processInfo.environment["TOKENCUE_FLICKER_PROBE_DIR"],
    ...
    static func startIfRequested(controller: StatusItemController) {
        ...
        let holdMode = ProcessInfo.processInfo.environment["TOKENCUE_FLICKER_PROBE_MODE"] == "hold"
