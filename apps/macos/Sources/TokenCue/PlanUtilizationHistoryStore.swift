...
struct PlanUtilizationHistoryBuckets: Equatable, Sendable {
    ...
    private static let unscopedIdentityKey = "__tokencue_unscoped__"
    private static let invalidatedIdentity = "__tokencue_invalidated__"
...
struct PlanUtilizationHistoryStore: Sendable {
    ...
    private static func defaultDirectoryURL() -> URL? {
        ...
        let dir = root.appendingPathComponent("com.tokencue.desktop", isDirectory: true)
