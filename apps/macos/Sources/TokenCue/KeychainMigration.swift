...
enum KeychainMigration {
    private static let log = TokenCueLog.logger(LogCategories.keychainMigration)
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.tokencue.desktop", account: "codex-cookie"),
        MigrationItem(service: "com.tokencue.desktop", account: "claude-cookie"),
        MigrationItem(service: "com.tokencue.desktop", account: "cursor-cookie"),
        MigrationItem(service: "com.tokencue.desktop", account: "factory-cookie"),
        MigrationItem(service: "com.tokencue.desktop", account: "minimax-cookie"),
        MigrationItem(service: "com.tokencue.desktop", account: "minimax-api-token"),
        MigrationItem(service: "com.tokencue.desktop", account: "augment-cookie"),
        MigrationItem(service: "com.tokencue.desktop", account: "copilot-api-token"),
        MigrationItem(service: "com.tokencue.desktop", account: "zai-api-token"),
        MigrationItem(service: "com.tokencue.desktop", account: "synthetic-api-key"),
    ]
