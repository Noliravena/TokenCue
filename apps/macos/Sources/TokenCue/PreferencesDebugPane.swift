        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(alignment: .leading, spacing: 20) {
                SettingsSection(title: L("section_logging")) {
                    ...
                    HStack(alignment: .center, spacing: 12) {
                        ...
                        Picker(L("Verbosity"), selection: self.$settings.debugLogLevel) {
                            ForEach(TokenCueLog.Level.allCases) { level in
                    ...
                    Button {
                        NSWorkspace.shared.open(TokenCueLog.fileLogURL)
                    } label: {
                    ...
                    caption: L("loading_animations_caption"))
                {
                    ...
                    Button {
                        NotificationCenter.default.post(name: .tokencueDebugBlinkNow, object: nil)
                    } label: {
