...
public enum HookRunner {
    private static let log = TokenCueLog.logger(LogCategories.hooks)
    public static let maximumPayloadBytes = 4096

    /// Environment keys forwarded to a hook. Deliberately narrow: TokenCue's own
