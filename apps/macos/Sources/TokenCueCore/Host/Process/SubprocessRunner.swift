...
public enum SubprocessRunnerError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        ...
        case let .binaryNotFound(binary):
            return "Missing CLI '\(binary)'. Install it and restart TokenCue."
...
public enum SubprocessRunner {
    private static let log = TokenCueLog.logger(LogCategories.subprocess)
    private static let timeoutQueue = DispatchQueue(
        label: "com.tokencue.desktop.subprocess.timeout",
        qos: .userInitiated,
