...
package final class ProcessPipeCapture: @unchecked Sendable {
    ...
    #if os(Linux)
    private let readerQueue = DispatchQueue(label: "com.tokencue.desktop.process-pipe-capture.reader")
    private let callbackQueue = DispatchQueue(label: "com.tokencue.desktop.process-pipe-capture.callback")
