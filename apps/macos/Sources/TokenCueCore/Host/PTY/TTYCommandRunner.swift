...
public struct TTYCommandRunner {
    private static let log = TokenCueLog.logger(LogCategories.ttyRunner)
    ...
    public enum Error: Swift.Error, LocalizedError, Sendable {
        ...
        public var errorDescription: String? {
            ...
            case .outputTooLarge: "PTY command produced more output than TokenCue can safely process."
            }
        }
    }
    ...
    static func locateBundledHelper(_ name: String) -> String? {
        ...
        if let override = ProcessInfo.processInfo.environment["TOKENCUE_HELPER_\(name.uppercased())"],
