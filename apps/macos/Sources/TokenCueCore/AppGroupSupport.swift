...
public enum AppGroupSupport {
    ...
    public static let teamIDInfoKey = "TokenCueTeamID"
    public static let legacyReleaseGroupID = "group.com.tokencue.desktop"
    public static let legacyDebugGroupID = "group.com.tokencue.desktop.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.tokencue.desktop"
        ...
        -> URL
    {
        ...
        let directory = base.appendingPathComponent("TokenCue", isDirectory: true)
