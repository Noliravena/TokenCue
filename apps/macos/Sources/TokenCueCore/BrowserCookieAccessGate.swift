...
public enum BrowserCookieAccessGate {
    ...
    private static let log = TokenCueLog.logger(LogCategories.browserCookieGate)
    ...
    static let allowTestCookieAccessEnvironmentKey = "TOKENCUE_ALLOW_TEST_BROWSER_COOKIE_ACCESS"
...
extension BrowserCookieClient {
    public func tokenCueStores(for browser: Browser) throws -> [BrowserCookieStore] {
