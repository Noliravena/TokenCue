...
public enum TokenCueSyncSchema {
...
public struct ProviderIntentPayload: Codable, Sendable {
    ...
    public init(config: ProviderConfig, schemaVersion: Int = TokenCueSyncSchema.currentVersion) {
...
public struct DeviceSyncPayload: Codable, Sendable {
    ...
    public init(
        ...
        appVersion: String,
        lastSeen: Date,
        schemaVersion: Int = TokenCueSyncSchema.currentVersion)
    {
        self.schemaVersion = schemaVersion
