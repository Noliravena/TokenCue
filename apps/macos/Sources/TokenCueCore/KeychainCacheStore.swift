...
public enum KeychainCacheStore {
    ...
    private static let log = TokenCueLog.logger(LogCategories.keychainCache)
    private static let cacheService = "com.tokencue.desktop.cache"
    private static let cacheLabel = "TokenCue Cache"
