...
public enum TokenCueConfigIssueSeverity: String, Codable, Sendable {
    case warning
    case error
}

public struct TokenCueConfigIssue: Codable, Sendable, Equatable {
    public let severity: TokenCueConfigIssueSeverity
    ...
    public init(
        severity: TokenCueConfigIssueSeverity,
...
public enum TokenCueConfigValidator {
    public static func validate(_ config: TokenCueConfig) -> [TokenCueConfigIssue] {
        var issues: [TokenCueConfigIssue] = []

        if config.version != TokenCueConfig.currentVersion {
            issues.append(TokenCueConfigIssue(
                severity: .error,
                provider: nil,
                field: "version",
    ...
    private static func validateHooks(_ hooks: HooksConfig?, issues: inout [TokenCueConfigIssue]) {
    ...
    private static func hookIssue(field: String, code: String, message: String) -> TokenCueConfigIssue {
        TokenCueConfigIssue(
            severity: .error,
            provider: nil,
            field: field,
    ...
    private static func validateProvider(_ entry: ProviderConfig, issues: inout [TokenCueConfigIssue]) {
    ...
    private static func validateSecretKey(_ entry: ProviderConfig, issues: inout [TokenCueConfigIssue]) {
    ...
    private static func validateRegion(_ entry: ProviderConfig, issues: inout [TokenCueConfigIssue]) {
