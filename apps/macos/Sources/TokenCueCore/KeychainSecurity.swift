...
enum KeychainTestSafety {
    static let suppressAccessEnvironmentKey = "TOKENCUE_SUPPRESS_TEST_KEYCHAIN_ACCESS"
    static let allowAccessEnvironmentKey = "TOKENCUE_ALLOW_TEST_KEYCHAIN_ACCESS"
