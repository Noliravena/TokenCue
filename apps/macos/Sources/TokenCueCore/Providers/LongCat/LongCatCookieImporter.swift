...
public enum LongCatCookieImporter {
    private static let log = TokenCueLog.logger(LogCategories.provider(.longcat, scope: "cookie"))
    private static let cookieClient = BrowserCookieClient()
    private static let cookieDomains = ["longcat.chat", "www.longcat.chat"]
    private static let cookieImportOrder: BrowserCookieImportOrder =
        ProviderDefaults.metadata[.longcat]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
