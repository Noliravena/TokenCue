...
public struct DeepSeekSettingsReader: Sendable {
    ...
    public static let profileIDEnvironmentKey = "TOKENCUE_DEEPSEEK_PROFILE_ID"
    public static let profileScopeEnvironmentKey = "TOKENCUE_DEEPSEEK_PROFILE_SCOPE"
    ...
    public static func profileScope(selectedTokenAccountID: UUID?, apiKey: String?) -> String? {
        ...
        let input = "com.tokencue.desktop.deepseek-profile-scope.v1\0\(accountScope)\0\(apiKey)"
