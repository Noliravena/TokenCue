...
public enum DeepgramUsageError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingAPIKey:
            "Missing Deepgram API key. Set apiKey in ~/.tokencue/config.json or DEEPGRAM_API_KEY."
...
public struct DeepgramUsageFetcher: Sendable {
    ...
    private static let log = TokenCueLog.logger(LogCategories.provider(.deepgram, scope: "usage"))
