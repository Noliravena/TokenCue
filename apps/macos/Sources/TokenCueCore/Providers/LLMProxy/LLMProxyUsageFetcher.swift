...
public enum LLMProxyUsageError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingCredentials:
            "Missing LLM Proxy API key. Set apiKey in ~/.tokencue/config.json or LLM_PROXY_API_KEY."
        case .missingBaseURL:
            "Missing LLM Proxy base URL. Set enterpriseHost in ~/.tokencue/config.json or LLM_PROXY_BASE_URL."
