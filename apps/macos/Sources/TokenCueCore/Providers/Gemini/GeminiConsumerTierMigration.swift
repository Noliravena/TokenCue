...
public enum GeminiConsumerTierMigration {
    ...
    Enable TokenCue's Antigravity provider, sign in to Antigravity or run `agy`, then refresh.
    """
    ...
    accounts blocked by the June 2026 Gemini CLI shutdown should use TokenCue's Antigravity \
