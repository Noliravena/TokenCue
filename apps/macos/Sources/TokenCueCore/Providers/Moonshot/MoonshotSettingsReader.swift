...
public struct MoonshotSettingsReader: Sendable {
    ...
    public static let configAPIKeyEnvironmentKey = "TOKENCUE_MOONSHOT_API_KEY"
    public static let configAPIKeyRegionEnvironmentKey = "TOKENCUE_MOONSHOT_API_KEY_REGION"
