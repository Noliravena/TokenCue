...
public struct ProviderCredentialAdapter: Sendable {
    ...
    public typealias ConfigValidator = @Sendable (_ config: ProviderConfig) -> [TokenCueConfigIssue]
    ...
    public func validateConfig(_ config: ProviderConfig) -> [TokenCueConfigIssue] {
