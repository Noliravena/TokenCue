...
public struct OpenRouterUsageFetcher: Sendable {
    private static let log = TokenCueLog.logger(LogCategories.provider(.openrouter, scope: "usage"))
    ...
    private static let debugFullErrorBodiesEnvKey = "TOKENCUE_DEBUG_OPENROUTER_ERROR_BODIES"
