...
private let augmentCookieImportOrder: BrowserCookieImportOrder =
    ProviderDefaults.metadata[.augment]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
...
public enum AugmentStatusProbeError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .notLoggedIn:
            "Not logged in to Augment. Please log in via the TokenCue menu."
