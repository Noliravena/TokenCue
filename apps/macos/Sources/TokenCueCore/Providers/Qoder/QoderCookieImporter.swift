...
public enum QoderCookieImporter {
    private static let log = TokenCueLog.logger(LogCategories.provider(.qoder, scope: "cookie"))
    private static let cookieClient = BrowserCookieClient()
    private static let cookieImportOrder: BrowserCookieImportOrder =
        ProviderDefaults.metadata[.qoder]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
