...
public enum AbacusCookieImporter {
    private static let log = TokenCueLog.logger(LogCategories.provider(.abacus, scope: "cookie"))
    private static let cookieClient = BrowserCookieClient()
    private static let cookieDomains = ["abacus.ai", "apps.abacus.ai"]
    private static let cookieImportOrder: BrowserCookieImportOrder =
        ProviderDefaults.metadata[.abacus]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
