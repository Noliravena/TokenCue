...
public enum NeuralWattUsageError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingCredentials:
            "Missing Neuralwatt API key. Set apiKey in the TokenCue config file or NEURALWATT_API_KEY."
...
public struct NeuralWattUsageFetcher: Sendable {
    private static let log = TokenCueLog.logger(LogCategories.provider(.neuralwatt, scope: "usage"))
