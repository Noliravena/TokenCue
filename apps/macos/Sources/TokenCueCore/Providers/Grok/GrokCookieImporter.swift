...
public enum GrokCookieImporter {
    ...
    private static let log = TokenCueLog.logger(LogCategories.providers)
    private static let cookieClient = BrowserCookieClient()
    private static let cookieDomains = ["grok.com"]
    private static let cookieImportOrder: BrowserCookieImportOrder =
        ProviderDefaults.metadata[.grok]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
