...
public struct ZaiSettingsReader: Sendable {
    private static let log = TokenCueLog.logger(LogCategories.provider(.zai, scope: "settings"))
...
public enum ZaiSettingsError: LocalizedError, Sendable, Equatable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingToken:
            "z.ai API token not found. Set apiKey in ~/.tokencue/config.json or Z_AI_API_KEY."
