...
public enum PerplexityCookieImporter {
    ...
    private static let log = TokenCueLog.logger(LogCategories.provider(.perplexity, scope: "cookie"))
    private static let cookieClient = BrowserCookieClient()
    private static let cookieDomains = ["www.perplexity.ai", "perplexity.ai"]
    private static let cookieImportOrder: BrowserCookieImportOrder =
        ProviderDefaults.metadata[.perplexity]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
    #if DEBUG
