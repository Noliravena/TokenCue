...
public enum BedrockSettingsReader {
    ...
    public static let budgetKey = "TOKENCUE_BEDROCK_BUDGET"
    public static let apiURLKey = "TOKENCUE_BEDROCK_API_URL"
    public static let cloudWatchAPIURLKey = "TOKENCUE_BEDROCK_CLOUDWATCH_API_URL"
    public static let profileKey = "AWS_PROFILE"
    public static let authModeKey = "TOKENCUE_BEDROCK_AUTH_MODE"
