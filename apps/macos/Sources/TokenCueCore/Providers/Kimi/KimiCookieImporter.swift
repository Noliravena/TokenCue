...
public enum KimiCookieImporter {
    ...
    private static let log = TokenCueLog.logger(LogCategories.provider(.kimi, scope: "cookie"))
    private static let cookieClient = BrowserCookieClient()
    private static let cookieDomains = ["www.kimi.com", "kimi.com"]
    private static let cookieImportOrder: BrowserCookieImportOrder =
        ProviderDefaults.metadata[.kimi]?.browserCookieOrder ?? TokenCueBrowserPolicy.supportedCookieSources
