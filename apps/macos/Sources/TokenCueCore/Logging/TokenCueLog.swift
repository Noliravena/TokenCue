...
public enum TokenCueLog {
    ...
    public static func logger(_ category: String) -> TokenCueLogger {
        let logger = Logger(label: "com.tokencue.desktop.\(category)")
        return TokenCueLogger(isEnabled: { level in
...
public struct TokenCueLogger: Sendable {
    private let isEnabled: @Sendable (TokenCueLog.Level) -> Bool
    private let logFn: @Sendable (TokenCueLog.Level, String, [String: String]?) -> Void

    fileprivate init(
        isEnabled: @escaping @Sendable (TokenCueLog.Level) -> Bool,
        log: @escaping @Sendable (TokenCueLog.Level, String, [String: String]?) -> Void)
    {
    ...
    init(
        minimumLevel: TokenCueLog.Level,
        log: @escaping @Sendable (TokenCueLog.Level, String, [String: String]?) -> Void)
    {
