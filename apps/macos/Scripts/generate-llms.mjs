...
if (!fs.existsSync(docsDir)) {
  console.log("skip llms generation: apps/macos/docs is not present in the TokenCue monorepo layout");
  process.exit(0);
}
const cnamePath = path.join(docsDir, "CNAME");
const cname = fs.existsSync(cnamePath)
  ? fs.readFileSync(cnamePath, "utf8").trim()
  : "github.com/Noliravena/TokenCue";
const origin = cname.includes("://") ? cname : "https://" + cname;
const productName = "TokenCue";
const source = "https://github.com/Noliravena/TokenCue";
...
const productDescription =
  ...
  "TokenCue shows AI coding-provider usage limits in the macOS menu bar.";
