...
assert_gate true source $'M\tSources/TokenCue/App.swift'
...
assert_gate true source-to-docs $'R100\tSources/TokenCue/App.swift\tdocs/App.md'
assert_gate true docs-to-source $'R100\tdocs/App.md\tSources/TokenCue/App.swift'
...
assert_linux_musl_gate true swift-source $'M\tSources/TokenCueCore/Process.swift'
assert_linux_musl_gate true nested-swift-source $'M\tSources/TokenCueCore/Host/Process/Process.swift'
assert_linux_musl_gate true rename-from-swift $'R100\tSources/TokenCueCore/Old.swift\tdocs/Old.md'
assert_linux_musl_gate true rename-to-swift $'R100\tdocs/New.md\tSources/TokenCueCore/New.swift'
assert_linux_musl_gate false tests-only $'M\tTests/TokenCueTests/ProcessTests.swift'
...
printf '%s\n' $'M\tSources/TokenCue/App.swift' > "$draft_paths"
