#!/usr/bin/env bash
# Reproducibly regenerates Sources/TokenCueCore/Resources/Plugins/sucrase-3.35.1.min.js
...
OUTPUT_FILE="${ROOT_DIR}/Sources/TokenCueCore/Resources/Plugins/sucrase-${SUCRASE_VERSION}.min.js"
MODE="${1:-check}"

WORK_DIR="$(mktemp -d /tmp/tokencue-sucrase-regen.XXXXXX)"
