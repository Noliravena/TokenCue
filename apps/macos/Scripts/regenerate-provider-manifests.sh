...
PROVIDERS_FILE="${ROOT_DIR}/Sources/TokenCueCore/Providers/Providers.swift"
DESCRIPTOR_DIR="${ROOT_DIR}/Sources/TokenCueCore/Providers"
IMPLEMENTATION_DIR="${ROOT_DIR}/Sources/TokenCue/Providers"
