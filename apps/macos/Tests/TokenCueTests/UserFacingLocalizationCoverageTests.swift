...
struct UserFacingLocalizationCoverageTests {
    ...
    func `selected user-facing UI surfaces avoid raw English literals`() throws {
        ...
        let forbiddenMarkersByFile: [String: [String]] = [
            "Sources/TokenCue/CostHistoryChartMenuView.swift": [
                ".value(\"Day\"",
                ".value(\"Cost\"",
                ".value(\"Cap start\"",
                ".value(\"Cap end\"",
            ],
            "Sources/TokenCue/CreditsHistoryChartMenuView.swift": [
                ".value(\"Day\"",
                ".value(\"Credits used\"",
                ".value(\"Cap start\"",
                ".value(\"Cap end\"",
            ...
            "Sources/TokenCue/PlanUtilizationHistoryChartMenuView.swift": [
                ".value(\"Series\"",
            ...
            "Sources/TokenCue/Providers/JetBrains/JetBrainsLoginFlow.swift": [
                "                \"Install a JetBrains IDE with AI Assistant enabled, then refresh TokenCue.\",",
                "                \"Alternatively, set a custom path in Settings.\",",
                "title: \"No JetBrains IDE detected\"",
            ],
            "Sources/TokenCue/PreferencesCodexAccountsSection.swift": [
                "?? \"No system account\"",
                ...
                "Text(\"Active\")",
                "Text(\"Choose which Codex account TokenCue should follow.\")",
                "Text(\"Account\")",
            ...
            "Sources/TokenCue/PreferencesProviderDetailView.swift": [
                ".help(\"Refresh\")",
                "accessibilityLabel: \"Usage used\"",
            ],
            "Sources/TokenCue/PreferencesProviderErrorView.swift": [
                ".help(\"Copy error\")",
            ],
            "Sources/TokenCue/PreferencesSpendDashboardPane.swift": [
                "Text(\"Model breakdown unavailable\")",
            ],
            "Sources/TokenCue/PreferencesProviderSettingsRows.swift": [
                "Text(self.title)",
            ...
            "Sources/TokenCue/PreferencesSidebar.swift": [
                "\"Disabled —",
                ".accessibilityLabel(\"Sort",
            ],
            "Sources/TokenCue/StatusItemController+CostMenuCard.swift": [
                "static let costMenuTitle",
            ],
            "Sources/TokenCue/UsageBreakdownChartMenuView.swift": [
                ".value(\"Day\"",
                ".value(\"Credits used\"",
                ".value(\"Service\"",
                ".value(\"Cap start\"",
    ...
    func `spend dashboard model breakdown state stays precise and localized`() throws {
        ...
        let source = try String(
            contentsOf: root.appendingPathComponent("Sources/TokenCue/PreferencesSpendDashboardPane.swift"),
            encoding: .utf8)
    ...
    func `spend dashboard chart keeps validated points when aggregate total is unavailable`() {
        ...
        TokenCueLocalizationOverride.$appLanguage.withValue("en") {
