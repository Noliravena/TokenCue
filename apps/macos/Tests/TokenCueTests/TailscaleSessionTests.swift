...
struct TailscaleSessionTests {
    ...
    func `remote session command negotiates v2 then v1 for PATH and bundled CLIs`() {
        #expect(RemoteSessionFetcher.remoteSessionsCommand() ==
            "tokencue sessions --json-v2 || tokencue sessions --json || " +
            "'/Applications/TokenCue.app/Contents/Helpers/TokenCueCLI' sessions --json-v2 || " +
            "'/Applications/TokenCue.app/Contents/Helpers/TokenCueCLI' sessions --json")
    }
}
