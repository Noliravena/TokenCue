...
struct TokenCueWidgetProviderTests {
    @Test
    ...
    func `supported providers fall back to codex when snapshot is empty`() {
        ...
        #expect(TokenCueSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.codex])
    }
    ...
    func `supported providers keep alibaba when it is the only enabled provider`() {
        ...
        #expect(TokenCueSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.alibaba])
    }
    ...
    func `supported providers keep alibaba token plan when it is the only enabled provider`() {
        ...
        #expect(TokenCueSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.alibabatokenplan])
    }
    ...
    func `supported providers keep Mistral when it is the only enabled provider`() {
        ...
        #expect(TokenCueSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.mistral])
    }
    ...
    func `supported providers keep Kimi when it is the only enabled provider`() {
        ...
        #expect(TokenCueSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.kimi])
    }
...
extension TokenCueWidgetProviderTests {
    @Test
    ...
    func `supported providers keep Cursor when it is the only enabled provider`() {
        ...
        #expect(TokenCueSwitcherTimelineProvider.supportedProviders(from: snapshot) == [.cursor])
    }
