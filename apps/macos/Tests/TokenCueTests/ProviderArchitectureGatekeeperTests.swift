...
@testable import TokenCueWidget
...
struct ProviderArchitectureGatekeeperTests {
    ...
    func `every provider descriptor has a loadable SVG resource`() throws {
        let resources = try Self.repoRoot()
            .appending(path: "Sources/TokenCue/Resources", directoryHint: .isDirectory)
    ...
    func `provider implementation path identifies only a real provider folder`() {
        ...
        #expect(Self.providerImplementationID(
            "Sources/TokenCue/Providers/Claude/ClaudeSettings.swift",
            providerIDsByFolderName: folders) == "claude")
        #expect(Self.providerImplementationID(
            "Sources/TokenCue/Providers/Shared/ProviderHelpers.swift",
            providerIDsByFolderName: folders) == nil)
        #expect(Self.providerImplementationID(
            "Sources/TokenCue/NotProviders/ClaudeSettings.swift",
            providerIDsByFolderName: folders) == nil)
    }
    ...
    func `provider folders exempt only their own provider references`() {
        let file = SourceFile(
            path: "Sources/TokenCue/Providers/Claude/ClaudeSettings.swift",
    ...
    private static let suppressedProviderReferences: [SuppressedProviderReference] = [
        SuppressedProviderReference(
            path: "Sources/TokenCue/CodexAccountUsageSnapshotStore.swift",
            line: 118,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/CodexOwnershipContext.swift",
            line: 54,
            anchor: ".toUsageSnapshot(provider: .codex, accountEmail: normalizedEmail)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/CopilotTokenStore.swift",
            line: 25,
            anchor: "private static let log = TokenCueLog.logger(LogCategories.provider(.copilot, scope: \"token-store\"))",
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCue/CursorLoginRunner.swift",
            line: 126,
            anchor: "private let logger = TokenCueLog.logger(LogCategories.provider(.cursor, scope: \"login\"))",
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/KimiTokenStore.swift",
            line: 25,
            anchor: "private static let log = TokenCueLog.logger(LogCategories.provider(.kimi, scope: \"token-store\"))",
            expectedProviderIDs: ["kimi"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/MenuBarMetricWindowResolver.swift",
            line: 128,
        ...
        SuppressedProviderReference(
            ...
            reason: "This named provider resolver supplies its fixed provider identity to the shared presentation helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/MiniMaxAPITokenStore.swift",
            line: 25,
            anchor: "private static let log = TokenCueLog.logger(LogCategories.provider(.minimax, scope: \"api-token-store\"))",
            expectedProviderIDs: ["minimax"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/MiniMaxCookieStore.swift",
            line: 25,
            anchor: "private static let log = TokenCueLog.logger(LogCategories.provider(.minimax, scope: \"cookie-store\"))",
            expectedProviderIDs: ["minimax"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/PredictivePaceWarnings.swift",
            line: 206,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCue/PreferencesProvidersPane+Testing.swift",
            line: 83,
        ...
        SuppressedProviderReference(
            ...
            reason: "This test-only app seam pins Codex fixture data and does not make production routing policy."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/SessionQuotaNotifications.swift",
            line: 460,
            anchor: "let removedState = self.sessionQuotaTransitionStates.removeValue(forKey: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This exact provider-owned construct passes a fixed identity to shared infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/SettingsStore+MenuObservation.swift",
            line: 94,
        ...
        SuppressedProviderReference(
            ...
            reason: "This observation touchpoint reads a fixed provider field so UI invalidation tracks that setting."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/SpendDashboardController.swift",
            line: 321,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This Codex account projection passes its fixed provider identity to shared spend infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/StatusItemController+CodexStackedMenu.swift",
            line: 26,
            anchor: "for: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/StatusItemController+CompactAccountMenu.swift",
            line: 72,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/StatusItemController+MemoryPressure.swift",
            line: 45,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCue/StatusItemController+Menu.swift",
            line: 1087,
            anchor: "controller.refreshOpenMenuIfStillVisible(menu, provider: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/SyntheticTokenStore.swift",
            line: 25,
            anchor: "private static let log = TokenCueLog.logger(LogCategories.provider(.synthetic, scope: \"token-store\"))",
            expectedProviderIDs: ["synthetic"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+Accessors.swift",
            line: 95,
            anchor: "accountID: self.settings.selectedTokenAccount(for: .deepseek)?.id,",
            expectedProviderIDs: ["deepseek"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+ClaudeDebug.swift",
            line: 111,
            anchor: "for: .claude,",
            expectedProviderIDs: ["claude"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+CodexCostCatchUp.swift",
            line: 20,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+HighestUsage.swift",
            line: 161,
            anchor: "let windows = IconRemainingResolver.resolvedWindows(snapshot: snapshot, style: .antigravity)",
            expectedProviderIDs: ["antigravity"],
            reason: "This named provider resolver supplies its fixed provider identity to the shared presentation helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+HistoricalPace.swift",
            line: 74,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+PlanUtilization.swift",
            line: 177,
            anchor: "self.sessionEquivalentBurnCache.removeValue(forKey: .codex)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+Refresh.swift",
            line: 436,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+RefreshEnrichment.swift",
            line: 279,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+SpendDashboardCodexCostCatchUp.swift",
            line: 27,
            anchor: "self.settings.isCostUsageEffectivelyEnabled(for: .codex),",
            expectedProviderIDs: ["codex"],
            reason: "This Codex account projection passes its fixed provider identity to shared spend infrastructure."),
        ...
        SuppressedProviderReference(
            ...
            reason: "This Codex account projection passes its fixed provider identity to shared spend infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+TokenAccounts.swift",
            line: 823,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+TokenCost.swift",
            line: 73,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+WidgetSnapshot.swift",
            line: 281,
        ...
        SuppressedProviderReference(
            ...
            reason: "Claude widget quota ownership uses the selected Claude account's isolated snapshot key."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore.swift",
            line: 1034,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/ZaiTokenStore.swift",
            line: 25,
            anchor: "private static let log = TokenCueLog.logger(LogCategories.provider(.zai, scope: \"token-store\"))",
            expectedProviderIDs: ["zai"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCLI/CLICardsRenderer.swift",
            line: 221,
            anchor: "provider: .claude,",
            expectedProviderIDs: ["claude"],
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            ...
            reason: "This provider-specific app branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCLI/CLICostCommand.swift",
            line: 180,
        ...
        SuppressedProviderReference(
            ...
            reason: "The Cursor-only cookie-settings resolver passes its fixed identity to token-account helpers."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/CodexLocalProjectUsageIndexer.swift",
            line: 64,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned integration passes its fixed identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/CostUsageFetcher.swift",
            line: 278,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/LocalAgentSessionScanner.swift",
            line: 258,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/OpenAIWeb/OpenAIDashboardBrowserCookieImporter.swift",
            line: 150,
        ...
        SuppressedProviderReference(
            ...
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/OpenAIWeb/OpenAIDashboardWebViewCache.swift",
            line: 16,
            anchor: "fileprivate static let log = TokenCueLog.logger(LogCategories.provider(.openai, scope: \"webview\"))",
            expectedProviderIDs: ["openai"],
            reason: "This provider-owned adapter passes its fixed identity to shared logging or cache infrastructure."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/ProviderStorageFootprint.swift",
            line: 146,
            anchor: "provider: .claude,",
            expectedProviderIDs: ["claude"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This inventory row records the provider that owns its static storage location."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/ProviderDiagnosticExport.swift",
            line: 414,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/UsageFetcher.swift",
            line: 1479,
            anchor: "providerID: .codex,",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Vendored/CostUsage/CostUsageCache.swift",
            line: 98,
            anchor: "let url = self.cacheFileURL(provider: .codex, cacheRoot: cacheRoot)",
            expectedProviderIDs: ["codex"],
            reason: "This provider-specific core branch passes its already-selected identity to a shared helper."),
        SuppressedProviderReference(
            path: "Sources/TokenCue/GeminiLoginRunner.swift",
            line: 7,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCue/UsageStore+OpenAIWeb.swift",
            line: 1518,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/AgentSession.swift",
            line: 389,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/DarwinProcessEnumerator.swift",
            line: 9,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/Antigravity/AntigravityStatusProbe.swift",
            line: 211,
            anchor: "matching: { $0.lowercased().contains(\"gemini\") },",
            expectedProviderIDs: ["gemini"],
            reason: "Antigravity quota payloads use this token to identify a model family, not a TokenCue provider."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/Antigravity/AntigravityStatusProbe.swift",
            line: 214,
        ...
        SuppressedProviderReference(
            ...
            reason: "Antigravity model identifiers use this token to classify a model family."),
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/AzureOpenAI/AzureOpenAIUsageFetcher.swift",
            line: 171,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/Gemini/GeminiStatusProbe.swift",
            line: 143,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/OpenCodeGo/OpenCodeGoLocalUsageReader.swift",
            line: 39,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueCore/Providers/ProviderVersionDetector.swift",
            line: 147,
        ...
        SuppressedProviderReference(
            path: "Sources/TokenCueWidget/BurnDownWidgetProvider.swift",
            line: 180,
            anchor: "provider: .codex,",
            expectedProviderIDs: ["codex"],
        ...
        SuppressedProviderReference(
            ...
            reason: "This WidgetKit default or preview pins the established Codex sample provider."),
        SuppressedProviderReference(
            path: "Sources/TokenCueWidget/TokenCueWidgetProvider.swift",
            line: 78,
    ...
    private static let allowedProviderConstructs: [AllowedProviderConstruct] = [
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/CostHistoryChartMenuView.swift",
            line: 950,
        ...
        AllowedProviderConstruct(
            path: "Sources/TokenCue/HistoricalUsagePace.swift",
            line: 221,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/IconRenderer.swift",
            line: 668,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/InlineUsageDashboardContent.swift",
            line: 260,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuBarLayout.swift",
            line: 253,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuBarLayoutEditor.swift",
            line: 629,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuCardView+CodexResetCredits.swift",
            line: 122,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuCardView+Costs.swift",
            line: 175,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuCardView+Kiro.swift",
            line: 7,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuCardView+ModelHelpers.swift",
            line: 185,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuCardView.swift",
            line: 191,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuDescriptor.swift",
            line: 197,
            anchor: "case .codex: \"⌘\"",
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/MenuOpenRefreshPlan.swift",
            line: 27,
        ...
        AllowedProviderConstruct(
            path: "Sources/TokenCue/PreferencesProvidersPane.swift",
            line: 274,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/PreferencesSpendDashboardPane.swift",
            line: 254,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/Providers/Shared/ProviderTokenAccountSelection.swift",
            line: 28,
        ...
        AllowedProviderConstruct(
            path: "Sources/TokenCue/ShareStatsPayload.swift",
            line: 163,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/SettingsStore+MenuPreferences.swift",
            line: 259,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/SettingsStore.swift",
            line: 1020,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/SpendDashboardModel+ModelBreakdown.swift",
            line: 113,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/SpendDashboardModel.swift",
            line: 639,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+AccountMenuDisplay.swift",
            line: 122,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+Actions.swift",
            line: 371,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+Animation.swift",
            line: 561,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+CostMenuCard.swift",
            line: 129,
            ...
            reason: "This exact shared renderer maps provider-owned presentation data into the generic UI model."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+CountdownRefresh.swift",
            line: 122,
            anchor: "if providers.contains(.codex) {",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 2,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+HostedSubmenus.swift",
            line: 422,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+MenuBarLayout.swift",
            line: 126,
            anchor: "if provider == .codex,",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+MenuSwitcherWarmup.swift",
            line: 70,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+MenuTracking.swift",
            line: 373,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+MenuTypes.swift",
            line: 14,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+MenuViewportRestore.swift",
            line: 611,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+OverviewSubmenus.swift",
            line: 10,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+ProviderNavigation.swift",
            line: 59,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController+SwitcherMetrics.swift",
            line: 16,
            anchor: "} else if provider == .mistral {",
            expectedProviderIDs: ["mistral"],
            expectedReferenceCount: 1,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/StatusItemController.swift",
            line: 365,
            anchor: "if provider == .codex {",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/UsageStore+LimitResetCelebration.swift",
            line: 100,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/UsageStore+LimitResetIdentity.swift",
            line: 11,
            anchor: "if provider == .codex {",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/UsageStore+ProviderStorage.swift",
            line: 253,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/UsageStore+QuotaWarnings.swift",
            line: 132,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/UsageStore+SessionEquivalents.swift",
            line: 183,
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCue/UsageStore+SessionQuotaTransition.swift",
            line: 54,
            anchor: "if provider == .codex,",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 2,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact app-runtime bridge coordinates provider-owned state through the shared controller."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCLI/CLICardsCommand.swift",
            line: 170,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact CLI construct preserves the provider-specific command and output contract."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCLI/CLIUsageCommand.swift",
            line: 182,
            anchor: "includeAllCodexAccounts: tokenSelection.allAccounts && providerList == [.codex],",
            expectedProviderIDs: ["codex"],
            expectedReferenceCount: 1,
        ...
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/CodexLocalDataScope.swift",
            line: 29,
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/Config/TokenCueConfig.swift",
            line: 172,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact host integration maps a provider-owned process, path, or window contract."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/OpenAIDashboardModels.swift",
            line: 146,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared construct dispatches a provider-owned capability at the generic integration boundary."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/PiSessionCostScanner.swift",
            line: 228,
            anchor: "guard provider == .codex || provider == .claude else { return nil }",
            expectedProviderIDs: ["claude", "codex"],
            expectedReferenceCount: 2,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/ProviderEndpointOverrideValidator.swift",
            line: 9,
        ...
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/PathEnvironment.swift",
            line: 536,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared provider integration dispatches a capability owned by the provider descriptor or adapter."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/Providers/ProviderCredentialAdapter.swift",
            line: 56,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact shared provider integration dispatches a capability owned by the provider descriptor or adapter."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/Providers/ProviderFetchPlan.swift",
            line: 194,
            anchor: "if provider == .kiro {",
            expectedProviderIDs: ["kiro"],
            expectedReferenceCount: 1,
            ...
            reason: "This exact shared provider integration dispatches a capability owned by the provider descriptor or adapter."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/SessionWindowFocuser.swift",
            line: 70,
            ...
            reason: "This exact host integration maps a provider-owned process, path, or window contract."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/UsageSnapshot+SwitcherWeeklyWindow.swift",
            line: 11,
            anchor: "case .factory:",
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/Vendored/CostUsage/CostUsagePricing.swift",
            line: 222,
        ...
        AllowedProviderConstruct(
            ...
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/Vendored/CostUsage/CostUsagePricingKey.swift",
            line: 13,
            ...
            reason: "This exact cost scanner dispatch selects a provider-owned transcript, cache, or pricing format."),
        AllowedProviderConstruct(
            path: "Sources/TokenCueCore/Vendored/CostUsage/ModelsDevPricing.swift",
            line: 75,
    ...
    private static func isLoggingCall(openingParenthesis: String.Index, in text: String) -> Bool {
        ...
        return identifiers.dropLast().contains { identifier in
            identifier == "log" || identifier == "logger" || identifier == "TokenCueLog" ||
