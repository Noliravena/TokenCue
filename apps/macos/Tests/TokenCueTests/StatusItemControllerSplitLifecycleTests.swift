...
struct StatusItemControllerSplitLifecycleTests {
    ...
    func `merged mode removes split provider status items`() throws {
        ...
        #expect(controller.expectedVisibleStatusItemAutosaveNames == ["tokencue-codex", "tokencue-claude"])
        ...
        #expect(controller.expectedVisibleStatusItemAutosaveNames == ["tokencue-merged"])
    }
    ...
    func `status items publish stable manager identity`() throws {
        ...
        #expect(controller.statusItem.autosaveName == "tokencue-merged")
        #expect(controller.statusItems[.codex]?.autosaveName == "tokencue-codex")
        #expect(controller.statusItems[.claude]?.autosaveName == "tokencue-claude")
        #expect(controller.statusItem.button?.accessibilityIdentifier() == "TokenCue.StatusItem")
        #expect(codexButton.accessibilityIdentifier() == "TokenCue.StatusItem.codex")
        #expect(claudeButton.accessibilityIdentifier() == "TokenCue.StatusItem.claude")
        #expect(controller.statusItem.button?.accessibilityTitle() == "TokenCue")
        #expect(codexButton.accessibilityTitle() == "TokenCue")
        #expect(claudeButton.accessibilityTitle() == "TokenCue")
    ...
    func `status item identity returns stable autosave names`() {
        #expect(StatusItemController.StatusItemIdentity.merged.autosaveName == "tokencue-merged")
        #expect(StatusItemController.StatusItemIdentity.provider(.codex).autosaveName == "tokencue-codex")
        #expect(StatusItemController.StatusItemIdentity.provider(.claude).autosaveName == "tokencue-claude")
    }
    ...
    func `status item placement preflight leaves fresh install placement unset`() throws {
        ...
        let key = MenuBarStatusItemPlacementPreflight.preferredPositionKey(autosaveName: "tokencue-merged")

        #expect(!MenuBarStatusItemPlacementPreflight.prepare(defaults: defaults, autosaveName: "tokencue-merged"))
    ...
    func `status item placement preflight clears provider matching suspicious legacy placement`() throws {
        ...
        defaults.set(42, forKey: "NSStatusItem Preferred Position Item-0")
        defaults.set(11298, forKey: "NSStatusItem Preferred Position Item-1")
        let key = MenuBarStatusItemPlacementPreflight.preferredPositionKey(autosaveName: "tokencue-codex")

        #expect(MenuBarStatusItemPlacementPreflight.prepare(
            defaults: defaults,
            autosaveName: "tokencue-codex",
    ...
    func `status item defaults repair removes stale hidden Control Center keys once`() throws {
        ...
        defaults.set(false, forKey: "NSStatusItem VisibleCC tokencue-merged")
        ...
        #expect(repairedKeys == [
            ...
            "NSStatusItem VisibleCC tokencue-merged",
        ])
        ...
        #expect(defaults.object(forKey: "NSStatusItem VisibleCC tokencue-merged") == nil)
    ...
    func `status item visibility default distinguishes enabled disabled and unset`() throws {
        ...
        let defaults = try #require(UserDefaults(suiteName: suite))
        defaults.removePersistentDomain(forName: suite)
        defaults.set(true, forKey: "NSStatusItem VisibleCC tokencue-merged")
        defaults.set(false, forKey: "NSStatusItem VisibleCC tokencue-claude")
        defer { defaults.removePersistentDomain(forName: suite) }

        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "tokencue-merged") == true)
        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "tokencue-claude") == false)
        #expect(MenuBarStatusItemDefaultsRepair.visibilityDefault(
            defaults: defaults,
            autosaveName: "tokencue-codex") == nil)
    }
    ...
    func `non destructive visibility refresh preserves split provider status items`() throws {
        ...
        #expect(newCodexItem.autosaveName == "tokencue-codex")
        #expect(newCodexItem.button?.accessibilityIdentifier() == "TokenCue.StatusItem.codex")
    }
    ...
    func `visibility recovery renders replacement merged status item`() throws {
        ...
        #expect(mergedButton.image != nil)
        #expect(controller.statusItem.autosaveName == "tokencue-merged")
        #expect(mergedButton.accessibilityIdentifier() == "TokenCue.StatusItem")
    }
}
