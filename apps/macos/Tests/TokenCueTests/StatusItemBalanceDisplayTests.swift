...
struct StatusItemBalanceDisplayTests {
    ...
    func `debug bundle identity updates status item accessibility`() {
        #expect(StatusItemController.isDebugApp(bundleIdentifier: "com.tokencue.desktop.debug"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: "com.tokencue.desktop"))
        #expect(!StatusItemController.isDebugApp(bundleIdentifier: nil))
        #expect(StatusItemController.statusItemAccessibilityTitle(isDebugApp: true) == "TokenCue Debug")
        #expect(StatusItemController.statusItemAccessibilityTitle(isDebugApp: false) == "TokenCue")
    }
