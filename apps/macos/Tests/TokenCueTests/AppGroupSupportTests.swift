...
struct AppGroupSupportTests {
    ...
    func `app group identifiers use resolved team-prefixed release and debug variants`() {
        #expect(
            AppGroupSupport.currentGroupID(teamID: "Y5PE65HELJ", bundleID: "com.tokencue.desktop")
                == "Y5PE65HELJ.com.tokencue.desktop")
        #expect(
            AppGroupSupport.currentGroupID(teamID: "ABCDE12345", bundleID: "com.tokencue.desktop.debug")
                == "ABCDE12345.com.tokencue.desktop.debug")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.tokencue.desktop")
                == "group.com.tokencue.desktop")
        #expect(
            AppGroupSupport.legacyGroupID(for: "com.tokencue.desktop.debug")
                == "group.com.tokencue.desktop.debug")
    }
