...
func testConfigStore(suiteName: String, reset: Bool = true) -> TokenCueConfigStore {
    ...
    return TokenCueConfigStore(fileURL: url)
}
...
func testSettingsStore(
    ...
    config: TokenCueConfig? = nil) -> SettingsStore
{
