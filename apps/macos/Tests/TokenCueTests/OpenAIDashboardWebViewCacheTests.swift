...
struct OpenAIDashboardWebViewCacheTests {
    ...
    func `Reused page reset clears one shot scraper globals`() async throws {
        ...
        _ = try await lease.webView.evaluateJavaScript(
            ...
            window.__tokencueUsageBreakdownJSON = '[{"day":"2026-04-19"}]';
            window.__tokencueUsageBreakdownDebug = 'debug';
            true;
            """)
        ...
        let reset = try await lease.webView.evaluateJavaScript(
            """
            typeof window.__tokencueDidScrollToCredits === 'undefined' &&
            typeof window.__tokencueUsageBreakdownJSON === 'undefined' &&
            typeof window.__tokencueUsageBreakdownDebug === 'undefined'
            """) as? Bool
