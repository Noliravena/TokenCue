...
struct ClaudeProbeWorkingDirectoryTests {
    ...
    func `probe project directory name matches Claude Code encoding`() {
        let cases = [
            (
                "/Users/test/Library/Application Support/TokenCue/ClaudeProbe",
                "-Users-test-Library-Application-Support-TokenCue-ClaudeProbe"),
            (
                "/Users/test.name/t\u{00E9}st_under/Library/Application Support/TokenCue/ClaudeProbe",
                "-Users-test-name-t-st-under-Library-Application-Support-TokenCue-ClaudeProbe"),
            (
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("tokencue-claude-probe-\(UUID().uuidString)", isDirectory: true)
