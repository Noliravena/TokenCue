...
/// List all browsers detected on this machine that TokenCue can read cookies from.
///
...
pub fn import_browser_cookies(
    ...
    use tokencue::browser::cookies::{CookieError, CookieExtractor};
    use tokencue::browser::detection::BrowserDetector;
...
fn browser_type_key(bt: tokencue::browser::detection::BrowserType) -> &'static str {
    use tokencue::browser::detection::BrowserType;
    match bt {
