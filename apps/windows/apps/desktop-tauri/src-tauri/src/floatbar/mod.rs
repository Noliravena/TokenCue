...
use tokencue::settings::Settings;
...
impl SettingsPatch {
    ...
    pub fn apply(&self, settings: &mut Settings) {
        ...
        if let Some(v) = self.opacity {
            settings.float_bar_opacity = tokencue::settings::clamp_float_bar_opacity(v);
        }
        if let Some(v) = self.scale {
            settings.float_bar_scale = tokencue::settings::clamp_float_bar_scale(v);
        }
        if let Some(v) = &self.orientation {
            settings.float_bar_orientation = tokencue::settings::normalize_float_bar_orientation(v);
        }
        if let Some(v) = &self.style {
            settings.float_bar_style = tokencue::settings::normalize_float_bar_style(v);
        }
