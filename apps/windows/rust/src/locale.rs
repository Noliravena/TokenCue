...
fn language_id(lang: Language) -> &'static LanguageIdentifier {
    ...
    static AR: LazyLock<LanguageIdentifier> = LazyLock::new(|| "ar".parse().unwrap());
    static CA: LazyLock<LanguageIdentifier> = LazyLock::new(|| "ca".parse().unwrap());
    static DE: LazyLock<LanguageIdentifier> = LazyLock::new(|| "de".parse().unwrap());
    static FA: LazyLock<LanguageIdentifier> = LazyLock::new(|| "fa".parse().unwrap());
    static FR: LazyLock<LanguageIdentifier> = LazyLock::new(|| "fr".parse().unwrap());
    static GL: LazyLock<LanguageIdentifier> = LazyLock::new(|| "gl".parse().unwrap());
    static ID: LazyLock<LanguageIdentifier> = LazyLock::new(|| "id".parse().unwrap());
    static IT: LazyLock<LanguageIdentifier> = LazyLock::new(|| "it".parse().unwrap());
    static NL: LazyLock<LanguageIdentifier> = LazyLock::new(|| "nl".parse().unwrap());
    static PL: LazyLock<LanguageIdentifier> = LazyLock::new(|| "pl".parse().unwrap());
    static PT_BR: LazyLock<LanguageIdentifier> = LazyLock::new(|| "pt-BR".parse().unwrap());
    static SV: LazyLock<LanguageIdentifier> = LazyLock::new(|| "sv".parse().unwrap());
    static TH: LazyLock<LanguageIdentifier> = LazyLock::new(|| "th".parse().unwrap());
    static TR: LazyLock<LanguageIdentifier> = LazyLock::new(|| "tr".parse().unwrap());
    static UK: LazyLock<LanguageIdentifier> = LazyLock::new(|| "uk".parse().unwrap());
    static VI: LazyLock<LanguageIdentifier> = LazyLock::new(|| "vi".parse().unwrap());
...
locale_keys! {
    ...
    NotificationSoundThemeTokenCue,
    ...
    // Tray warm-UI tabs & empty state
    TrayTabQuota,
    TrayTabSpend,
    TrayTabHistory,
    TrayTabSettings,
    TrayEmptyTitle,
    TrayEmptyDescription,
    TrayEmptyConnect,
    TrayLocalPrivacy,
    TrayCurrentAlerts,
    TrayNoCurrentAlerts,
    TrayOpenFullSettings,
    TrayTodayLabel,
    TrayLast30DaysLabel,
    TrayUpdatedAgo,
    TrayFixProvider,
    TraySpendDisclaimer,
    TraySpendAxisStart,
    TrayHistoryRangeDays,
    TrayHistoryRangeLabel,
    TrayHistoryProviderLabel,
    TrayHistoryCumulative,
    TrayProvidersEnabled,
    ProviderStatusNotConfigured,
    ProviderStatusWaiting,
    ProviderStatusNeedsAttention,
    ProviderStatusConnected,
    ProvidersEnabledOfTotal,
    ProvidersSearchPlaceholder,
    ProvidersAddButton,
    ProvidersNoMatches,
    ProvidersCredentialHint,
    ProviderMoveUp,
    ProviderMoveDown,
    ProviderToggleEnabled,
    DisplayModeDetailedSample,
    DisplayModeCompactSample,
    DisplayModeMinimalSample,
