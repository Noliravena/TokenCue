...
use crate::providers::{
    ...
    ClaudeProvider, ClawRouterProvider, ClinePassProvider, CodebuffProvider, CodexProvider,
    ...
    MiniMaxProvider, MistralProvider, MoonshotProvider, NanoGPTProvider, NeuralwattProvider,
    ...
    SakanaProvider, StepFunProvider, Sub2ApiProvider, SyntheticProvider, T3ChatProvider,
...
pub fn instantiate(id: ProviderId) -> Box<dyn Provider> {
    match id {
        ...
        ProviderId::Moonshot => Box::new(MoonshotProvider::new()),
        ProviderId::Synthetic => Box::new(SyntheticProvider::new()),
        ProviderId::ClawRouter => Box::new(ClawRouterProvider::new()),
    }
}
