...
//!
//! Fetches via `GET https://api.aiand.com/logs?range=30days&limit=100` with
//! Bearer auth, paginating up to 10 pages via `after` / `after_id` cursors.
...
const CREDENTIAL_TARGET: &str = "tokencue-aiand";
