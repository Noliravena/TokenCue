...
mod tests {
    ...
    #[test]
    fn cli_compatibility_path_is_covered_without_reading_live_browser_credentials() {
        let provider = CursorProvider::new();
        // `Cli` intentionally shares Cursor's browser-backed implementation;
        // the public source catalog remains Web/Auto and no test may probe a
        // real browser profile just to verify this compatibility behavior.
        assert!(provider.available_sources().contains(&SourceMode::Web));
