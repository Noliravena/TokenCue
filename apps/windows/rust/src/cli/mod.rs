...
//!
//! TokenCue command-line interface:
//! - `tokencue usage` - print usage from providers
//! - `tokencue cost` - print local token cost usage
//! - `tokencue plugins` - manage sandboxed provider plugins
//! - `tokencue autostart` - manage Windows auto-start
...
/// Stable TokenCue CLI exit codes
pub mod exit_codes {
    ...
    /// Quota could not be checked (`EX_UNAVAILABLE`); used by `tokencue guard`.
    pub const UNAVAILABLE: i32 = 69;
}

/// TokenCue - Monitor AI provider usage limits
///
...
pub enum Commands {
    ...
    /// List, fetch, or revoke sandboxed JavaScript/TypeScript provider plugins
