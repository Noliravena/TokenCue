# TokenCue notification sounds

These notification sounds use deterministic procedural DSP. They contain no
sampled audio and are distributed under the applicable repository licenses.
